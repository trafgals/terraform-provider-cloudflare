...
import (
	...
	"github.com/trafgals/terraform-provider-cloudflare-trafgals/internal/services/zero_trust_device_default_profile_local_domain_fallback/migration/v500"
	"github.com/hashicorp/terraform-plugin-framework/resource"
)

var _ resource.ResourceWithUpgradeState = (*ZeroTrustDeviceDefaultProfileLocalDomainFallbackResource)(nil)
var _ resource.ResourceWithMoveState = (*ZeroTrustDeviceDefaultProfileLocalDomainFallbackResource)(nil)
...
// from legacy fallback domain resources (without policy_id) to this default profile resource.
func (r *ZeroTrustDeviceDefaultProfileLocalDomainFallbackResource) MoveState(ctx context.Context) []resource.StateMover {
	sourceSchema := v500.SourceCloudflareFallbackDomainSchema()

	return []resource.StateMover{
		{
			SourceSchema: &sourceSchema,
			StateMover:   v500.MoveFallbackDomainToDefaultProfile,
		},
	}
}
...
func (r *ZeroTrustDeviceDefaultProfileLocalDomainFallbackResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
	...
	return map[int64]resource.StateUpgrader{
		...
		// resources WITHOUT policy_id to this default profile resource
		0: {
