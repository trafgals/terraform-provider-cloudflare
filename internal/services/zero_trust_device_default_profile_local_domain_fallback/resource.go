...
// ZeroTrustDeviceDefaultProfileLocalDomainFallbackResource defines the resource implementation.
type ZeroTrustDeviceDefaultProfileLocalDomainFallbackResource struct {
	client *cloudflare.Client
}

func (r *ZeroTrustDeviceDefaultProfileLocalDomainFallbackResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_zero_trust_device_default_profile_local_domain_fallback"
}

func (r *ZeroTrustDeviceDefaultProfileLocalDomainFallbackResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ZeroTrustDeviceDefaultProfileLocalDomainFallbackResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ZeroTrustDeviceDefaultProfileLocalDomainFallbackModel
...
func (r *ZeroTrustDeviceDefaultProfileLocalDomainFallbackResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ZeroTrustDeviceDefaultProfileLocalDomainFallbackModel
	...
	var state *ZeroTrustDeviceDefaultProfileLocalDomainFallbackModel
...
func (r *ZeroTrustDeviceDefaultProfileLocalDomainFallbackResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ZeroTrustDeviceDefaultProfileLocalDomainFallbackModel
