...
var _ datasource.DataSourceWithConfigValidators = (*ZeroTrustDLPCustomEntryDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"confidence": schema.SingleNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectType[ZeroTrustDLPCustomEntryConfidenceDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
			...
			"pattern": schema.SingleNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectType[ZeroTrustDLPCustomEntryPatternDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
			...
			"profiles": schema.ListNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectListType[ZeroTrustDLPCustomEntryProfilesDataSourceModel](ctx),
			...
			"variant": schema.SingleNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectType[ZeroTrustDLPCustomEntryVariantDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
...
func (d *ZeroTrustDLPCustomEntryDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *ZeroTrustDLPCustomEntryDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
