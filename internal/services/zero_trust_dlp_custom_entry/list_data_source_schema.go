...
var _ datasource.DataSourceWithConfigValidators = (*ZeroTrustDLPCustomEntriesDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"result": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[ZeroTrustDLPCustomEntriesResultDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"pattern": schema.SingleNestedAttribute{
							Computed:   true,
							CustomType: customfield.NewNestedObjectType[ZeroTrustDLPCustomEntriesPatternDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
						...
						"confidence": schema.SingleNestedAttribute{
							Computed:   true,
							CustomType: customfield.NewNestedObjectType[ZeroTrustDLPCustomEntriesConfidenceDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
...
func (d *ZeroTrustDLPCustomEntriesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *ZeroTrustDLPCustomEntriesDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
