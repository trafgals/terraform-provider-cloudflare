				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"dns": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[SpectrumApplicationsDNSDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
						...
						"edge_ips": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[SpectrumApplicationsEdgeIPsDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
						...
						"origin_dns": schema.SingleNestedAttribute{
							Description: "The name and type of DNS record for the Spectrum application.",
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[SpectrumApplicationsOriginDNSDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								"name": schema.StringAttribute{
