...
var _ datasource.DataSourceWithConfigValidators = (*PipelineSinkDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"config": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[PipelineSinkConfigDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"account_id": schema.StringAttribute{
					...
					"credentials": schema.SingleNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectType[PipelineSinkConfigCredentialsDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
					...
					"file_naming": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[PipelineSinkConfigFileNamingDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
					...
					"partitioning": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[PipelineSinkConfigPartitioningDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
					...
					"rolling_policy": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[PipelineSinkConfigRollingPolicyDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
			...
			"format": schema.SingleNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectType[PipelineSinkFormatDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"type": schema.StringAttribute{
			...
			"schema": schema.SingleNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectType[PipelineSinkSchemaDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"fields": schema.ListNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectListType[PipelineSinkSchemaFieldsDataSourceModel](ctx),
					...
					"format": schema.SingleNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectType[PipelineSinkSchemaFormatDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"type": schema.StringAttribute{
								Description: `Available values: "json", "parquet".`,
								Computed:    true,
...
func (d *PipelineSinkDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *PipelineSinkDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
	return []datasource.ConfigValidator{
		datasourcevalidator.ExactlyOneOf(path.MatchRoot("sink_id"), path.MatchRoot("filter")),
	}
}
