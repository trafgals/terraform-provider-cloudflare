...
var _ datasource.DataSourceWithConfigValidators = (*AccountDNSSettingsDataSource)(nil)
			...
			"zone_defaults": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"internal_dns": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[AccountDNSSettingsZoneDefaultsInternalDNSDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
					...
					"soa": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[AccountDNSSettingsZoneDefaultsSOADataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
...
func (d *AccountDNSSettingsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *AccountDNSSettingsDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
