...
var _ datasource.DataSourceWithConfigValidators = (*AuthenticatedOriginPullsHostnameCertificatesDataSource)(nil)
...
func (d *AuthenticatedOriginPullsHostnameCertificatesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *AuthenticatedOriginPullsHostnameCertificatesDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
