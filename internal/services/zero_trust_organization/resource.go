...
// ZeroTrustOrganizationResource defines the resource implementation.
type ZeroTrustOrganizationResource struct {
	client *cloudflare.Client
}

func (r *ZeroTrustOrganizationResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_zero_trust_organization"
}

func (r *ZeroTrustOrganizationResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ZeroTrustOrganizationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ZeroTrustOrganizationModel
...
func (r *ZeroTrustOrganizationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ZeroTrustOrganizationModel
	...
	var state *ZeroTrustOrganizationModel
...
func (r *ZeroTrustOrganizationResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ZeroTrustOrganizationModel
