...
var _ datasource.DataSourceWithConfigure = (*ZeroTrustDeviceManagedNetworksListDataSource)(nil)
...
func (d *ZeroTrustDeviceManagedNetworksListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	env := ZeroTrustDeviceManagedNetworksListResultListDataSourceEnvelope{}
	...
	result, diags := customfield.NewObjectListFromAttributes[ZeroTrustDeviceManagedNetworksListResultDataSourceModel](ctx, acc)
	resp.Diagnostics.Append(diags...)
	data.Result = result
