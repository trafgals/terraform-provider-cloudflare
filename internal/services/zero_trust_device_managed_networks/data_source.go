...
type ZeroTrustDeviceManagedNetworksDataSource struct {
...
func (d *ZeroTrustDeviceManagedNetworksDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_zero_trust_device_managed_networks"
}

func (d *ZeroTrustDeviceManagedNetworksDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ZeroTrustDeviceManagedNetworksDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ZeroTrustDeviceManagedNetworksDataSourceModel
