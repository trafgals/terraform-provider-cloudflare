...
var _ datasource.DataSourceWithConfigure = (*ZeroTrustAccessTagsDataSource)(nil)
...
func (d *ZeroTrustAccessTagsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	env := ZeroTrustAccessTagsResultListDataSourceEnvelope{}
	...
	result, diags := customfield.NewObjectListFromAttributes[ZeroTrustAccessTagsResultDataSourceModel](ctx, acc)
	resp.Diagnostics.Append(diags...)
	data.Result = result
