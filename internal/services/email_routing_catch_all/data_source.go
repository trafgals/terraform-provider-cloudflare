...
type EmailRoutingCatchAllDataSource struct {
...
func (d *EmailRoutingCatchAllDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
