...
// WorkersScriptSubdomainResource defines the resource implementation.
type WorkersScriptSubdomainResource struct {
	client *cloudflare.Client
}

func (r *WorkersScriptSubdomainResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_workers_script_subdomain"
}

func (r *WorkersScriptSubdomainResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *WorkersScriptSubdomainResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *WorkersScriptSubdomainResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *WorkersScriptSubdomainModel
	...
	var state *WorkersScriptSubdomainModel
...
func (r *WorkersScriptSubdomainResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *WorkersScriptSubdomainModel
