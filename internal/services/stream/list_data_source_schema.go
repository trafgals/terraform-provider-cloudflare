...
var _ datasource.DataSourceWithConfigValidators = (*StreamsDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"result": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[StreamsResultDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"input": schema.SingleNestedAttribute{
							Computed:   true,
							CustomType: customfield.NewNestedObjectType[StreamsInputDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
						...
						"playback": schema.SingleNestedAttribute{
							Computed:   true,
							CustomType: customfield.NewNestedObjectType[StreamsPlaybackDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
						...
						"status": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[StreamsStatusDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
						...
						"watermark": schema.SingleNestedAttribute{
							Computed:   true,
							CustomType: customfield.NewNestedObjectType[StreamsWatermarkDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								"created": schema.StringAttribute{
...
func (d *StreamsDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
