...
import (
	...
	v500 "github.com/trafgals/terraform-provider-cloudflare-trafgals/internal/services/zero_trust_gateway_policy/migration/v500"
...
var _ resource.ResourceWithMoveState = (*ZeroTrustGatewayPolicyResource)(nil)
...
func (r *ZeroTrustGatewayPolicyResource) MoveState(ctx context.Context) []resource.StateMover {
	sourceSchema := v500.SourceCloudflareTeamsRuleSchema()
...
//   - rule_settings stored as ARRAY (ListNestedBlock) → OBJECT (SingleNestedAttribute)
//
...
//   - State already has rule_settings as object, no transformation needed
//
...
func (r *ZeroTrustGatewayPolicyResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
	...
	return map[int64]resource.StateUpgrader{
		...
		// - v4: rule_settings as ListNestedBlock (array)
		// - v5: rule_settings as SingleNestedAttribute (object)
