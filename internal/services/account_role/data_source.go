...
var _ datasource.DataSourceWithConfigure = (*AccountRoleDataSource)(nil)

func NewAccountRoleDataSource() datasource.DataSource {
	return &AccountRoleDataSource{}
}

func (d *AccountRoleDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_account_role"
}

func (d *AccountRoleDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *AccountRoleDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *AccountRoleDataSourceModel
	...
	env := AccountRoleResultDataSourceEnvelope{*data}
	_, err := d.client.Accounts.Roles.Get(
		ctx,
