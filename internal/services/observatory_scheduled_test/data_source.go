...
type ObservatoryScheduledTestDataSource struct {
...
func (d *ObservatoryScheduledTestDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
