			...
			"context_awareness": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"skip": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[ZeroTrustDLPCustomProfileContextAwarenessSkipDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"pattern": schema.SingleNestedAttribute{
							Computed:   true,
							CustomType: customfield.NewNestedObjectType[ZeroTrustDLPCustomProfileEntriesPatternDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
