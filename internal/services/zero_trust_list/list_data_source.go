...
var _ datasource.DataSourceWithConfigure = (*ZeroTrustListsDataSource)(nil)
...
func (d *ZeroTrustListsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	result, diags := customfield.NewObjectListFromAttributes[ZeroTrustListsResultDataSourceModel](ctx, acc)
	resp.Diagnostics.Append(diags...)
	data.Result = result
