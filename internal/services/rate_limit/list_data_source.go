...
var _ datasource.DataSourceWithConfigure = (*RateLimitsDataSource)(nil)
...
func (d *RateLimitsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	env := RateLimitsResultListDataSourceEnvelope{}
	...
	result, diags := customfield.NewObjectListFromAttributes[RateLimitsResultDataSourceModel](ctx, acc)
	resp.Diagnostics.Append(diags...)
	data.Result = result
