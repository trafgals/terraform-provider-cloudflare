...
var _ datasource.DataSourceWithConfigValidators = (*RateLimitDataSource)(nil)
			...
			"action": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"response": schema.SingleNestedAttribute{
						...
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[RateLimitActionResponseDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
			...
			"match": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"headers": schema.ListNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectListType[RateLimitMatchHeadersDataSourceModel](ctx),
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"name": schema.StringAttribute{
					...
					"request": schema.SingleNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectType[RateLimitMatchRequestDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
					...
					"response": schema.SingleNestedAttribute{
						Computed:   true,
						CustomType: customfield.NewNestedObjectType[RateLimitMatchResponseDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
