...
var _ datasource.DataSourceWithConfigure = (*LogpushJobsDataSource)(nil)
...
func (d *LogpushJobsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	env := LogpushJobsResultListDataSourceEnvelope{}
	...
	result, diags := customfield.NewObjectListFromAttributes[LogpushJobsResultDataSourceModel](ctx, acc)
	resp.Diagnostics.Append(diags...)
	data.Result = result
