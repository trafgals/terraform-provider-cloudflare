...
type APIShieldDataSource struct {
...
func (d *APIShieldDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
