...
var _ resource.ResourceWithConfigure = (*APIShieldResource)(nil)
var _ resource.ResourceWithModifyPlan = (*APIShieldResource)(nil)
var _ resource.ResourceWithImportState = (*APIShieldResource)(nil)

func NewResource() resource.Resource {
	return &APIShieldResource{}
}

// APIShieldResource defines the resource implementation.
type APIShieldResource struct {
	client *cloudflare.Client
}

func (r *APIShieldResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_api_shield"
}

func (r *APIShieldResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *APIShieldResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *APIShieldModel
...
func (r *APIShieldResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *APIShieldModel
...
func (r *APIShieldResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *APIShieldModel
