...
type ZeroTrustDLPEntryDataSourceModel struct {
	...
	Profiles      customfield.NestedObjectList[ZeroTrustDLPEntryProfilesDataSourceModel] `tfsdk:"profiles" json:"profiles,computed"`
...
type ZeroTrustDLPEntryProfilesDataSourceModel struct {
