...
var _ datasource.DataSourceWithConfigure = (*APIShieldSchemasDataSource)(nil)
...
func (d *APIShieldSchemasDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	env := APIShieldSchemasResultListDataSourceEnvelope{}
	...
	result, diags := customfield.NewObjectListFromAttributes[APIShieldSchemasResultDataSourceModel](ctx, acc)
	resp.Diagnostics.Append(diags...)
	data.Result = result
