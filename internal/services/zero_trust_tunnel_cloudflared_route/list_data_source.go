...
var _ datasource.DataSourceWithConfigure = (*ZeroTrustTunnelCloudflaredRoutesDataSource)(nil)
...
func (d *ZeroTrustTunnelCloudflaredRoutesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	result, diags := customfield.NewObjectListFromAttributes[ZeroTrustTunnelCloudflaredRoutesResultDataSourceModel](ctx, acc)
	resp.Diagnostics.Append(diags...)
	data.Result = result
