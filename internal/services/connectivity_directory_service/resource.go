...
// ConnectivityDirectoryServiceResource defines the resource implementation.
...
func (r *ConnectivityDirectoryServiceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	var state *ConnectivityDirectoryServiceModel
...
func (r *ConnectivityDirectoryServiceResource) ModifyPlan(_ context.Context, _ resource.ModifyPlanRequest, _ *resource.ModifyPlanResponse) {
