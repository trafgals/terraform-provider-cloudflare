...
var _ datasource.DataSourceWithConfigure = (*ConnectivityDirectoryServiceDataSource)(nil)

func NewConnectivityDirectoryServiceDataSource() datasource.DataSource {
...
func (d *ConnectivityDirectoryServiceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	env := ConnectivityDirectoryServiceResultDataSourceEnvelope{*data}
	_, err := d.client.Connectivity.Directory.Services.Get(
		ctx,
