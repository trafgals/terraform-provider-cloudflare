						...
						"action_parameters": schema.SingleNestedAttribute{
							...
							Attributes: map[string]schema.Attribute{
								...
								"max_age": schema.SingleNestedAttribute{
									...
									CustomType: customfield.NewNestedObjectType[RulesetRulesActionParametersSetCacheControlValueDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"operation": schema.StringAttribute{
								...
								"private": schema.SingleNestedAttribute{
									...
									CustomType: customfield.NewNestedObjectType[RulesetRulesActionParametersSetCacheControlQualifiersDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"operation": schema.StringAttribute{
											Description: "The operation to perform.\nAvailable values: \"set\", \"remove\".",
											Computed:    true,
								...
								"must_revalidate": schema.SingleNestedAttribute{
									...
									CustomType: customfield.NewNestedObjectType[RulesetRulesActionParametersSetCacheControlSimpleDataSourceModel](ctx),
									Attributes: map[string]schema.Attribute{
										"operation": schema.StringAttribute{
											Description: "The operation to perform.\nAvailable values: \"set\", \"remove\".",
											Computed:    true,
