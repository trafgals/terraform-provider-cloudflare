				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"certificates": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[CertificatePacksCertificatesDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"id": schema.StringAttribute{
									...
									"geo_restrictions": schema.SingleNestedAttribute{
										...
										Computed:    true,
										CustomType:  customfield.NewNestedObjectType[CertificatePacksCertificatesGeoRestrictionsDataSourceModel](ctx),
										Attributes: map[string]schema.Attribute{
						...
						"dcv_delegation_records": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[CertificatePacksDCVDelegationRecordsDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
						...
						"validation_errors": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[CertificatePacksValidationErrorsDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
						...
						"validation_records": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[CertificatePacksValidationRecordsDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
									"cname": schema.StringAttribute{
										Description: "The CNAME record hostname for DCV delegation.",
