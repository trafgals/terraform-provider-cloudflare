...
type WorkersForPlatformsDispatchNamespaceDataSource struct {
...
func (d *WorkersForPlatformsDispatchNamespaceDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_workers_for_platforms_dispatch_namespace"
}

func (d *WorkersForPlatformsDispatchNamespaceDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *WorkersForPlatformsDispatchNamespaceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *WorkersForPlatformsDispatchNamespaceDataSourceModel
	...
	env := WorkersForPlatformsDispatchNamespaceResultDataSourceEnvelope{*data}
