...
var _ resource.ResourceWithConfigure = (*ContentScanningResource)(nil)
var _ resource.ResourceWithModifyPlan = (*ContentScanningResource)(nil)

func NewResource() resource.Resource {
	return &ContentScanningResource{}
}

// ContentScanningResource defines the resource implementation.
type ContentScanningResource struct {
	client *cloudflare.Client
}

func (r *ContentScanningResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_content_scanning"
}

func (r *ContentScanningResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ContentScanningResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
