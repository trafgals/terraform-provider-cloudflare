...
var _ datasource.DataSourceWithConfigValidators = (*StreamWatermarksDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"result": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[StreamWatermarksResultDataSourceModel](ctx),
...
func (d *StreamWatermarksDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *StreamWatermarksDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
