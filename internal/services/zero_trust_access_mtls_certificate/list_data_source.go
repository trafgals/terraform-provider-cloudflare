...
var _ datasource.DataSourceWithConfigure = (*ZeroTrustAccessMTLSCertificatesDataSource)(nil)
...
func (d *ZeroTrustAccessMTLSCertificatesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	env := ZeroTrustAccessMTLSCertificatesResultListDataSourceEnvelope{}
	...
	result, diags := customfield.NewObjectListFromAttributes[ZeroTrustAccessMTLSCertificatesResultDataSourceModel](ctx, acc)
	resp.Diagnostics.Append(diags...)
	data.Result = result
