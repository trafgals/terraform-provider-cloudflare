...
var _ datasource.DataSourceWithConfigure = (*LoadBalancerPoolsDataSource)(nil)
...
func (d *LoadBalancerPoolsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	env := LoadBalancerPoolsResultListDataSourceEnvelope{}
	...
	result, diags := customfield.NewObjectListFromAttributes[LoadBalancerPoolsResultDataSourceModel](ctx, acc)
	resp.Diagnostics.Append(diags...)
	data.Result = result
