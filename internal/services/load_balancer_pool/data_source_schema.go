...
var _ datasource.DataSourceWithConfigValidators = (*LoadBalancerPoolDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"load_shedding": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[LoadBalancerPoolLoadSheddingDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
			...
			"notification_filter": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[LoadBalancerPoolNotificationFilterDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
					"origin": schema.SingleNestedAttribute{
						Description: "Filter options for a particular resource type (pool or origin). Use null to reset.",
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[LoadBalancerPoolNotificationFilterOriginDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
					...
					"pool": schema.SingleNestedAttribute{
						Description: "Filter options for a particular resource type (pool or origin). Use null to reset.",
						Computed:    true,
						CustomType:  customfield.NewNestedObjectType[LoadBalancerPoolNotificationFilterPoolDataSourceModel](ctx),
						Attributes: map[string]schema.Attribute{
							"disable": schema.BoolAttribute{
								Description: "If set true, disable notifications for this type of resource (pool or origin).",
								Computed:    true,
			...
			"origins": schema.SetNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectSetType[LoadBalancerPoolOriginsDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"header": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[LoadBalancerPoolOriginsHeaderDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
...
func (d *LoadBalancerPoolDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
