...
var _ datasource.DataSourceWithConfigValidators = (*ZeroTrustDLPPredefinedEntryDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"confidence": schema.SingleNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectType[ZeroTrustDLPPredefinedEntryConfidenceDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
			...
			"pattern": schema.SingleNestedAttribute{
				Computed:   true,
				CustomType: customfield.NewNestedObjectType[ZeroTrustDLPPredefinedEntryPatternDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
...
func (d *ZeroTrustDLPPredefinedEntryDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = DataSourceSchema(ctx)
}

func (d *ZeroTrustDLPPredefinedEntryDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
