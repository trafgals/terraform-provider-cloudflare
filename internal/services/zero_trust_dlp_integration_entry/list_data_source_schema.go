...
var _ datasource.DataSourceWithConfigValidators = (*ZeroTrustDLPIntegrationEntriesDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"result": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[ZeroTrustDLPIntegrationEntriesResultDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"pattern": schema.SingleNestedAttribute{
							Computed:   true,
							CustomType: customfield.NewNestedObjectType[ZeroTrustDLPIntegrationEntriesPatternDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
						...
						"confidence": schema.SingleNestedAttribute{
							Computed:   true,
							CustomType: customfield.NewNestedObjectType[ZeroTrustDLPIntegrationEntriesConfidenceDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
						...
						"variant": schema.SingleNestedAttribute{
							Computed:   true,
							CustomType: customfield.NewNestedObjectType[ZeroTrustDLPIntegrationEntriesVariantDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
...
func (d *ZeroTrustDLPIntegrationEntriesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *ZeroTrustDLPIntegrationEntriesDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
