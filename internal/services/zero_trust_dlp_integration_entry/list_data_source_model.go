...
type ZeroTrustDLPIntegrationEntriesResultListDataSourceEnvelope struct {
	Result customfield.NestedObjectList[ZeroTrustDLPIntegrationEntriesResultDataSourceModel] `json:"result,computed"`
}
...
type ZeroTrustDLPIntegrationEntriesResultDataSourceModel struct {
	...
	Variant       customfield.NestedObject[ZeroTrustDLPIntegrationEntriesVariantDataSourceModel]    `tfsdk:"variant" json:"variant,computed"`
...
type ZeroTrustDLPIntegrationEntriesPatternDataSourceModel struct {
	Regex      types.String `tfsdk:"regex" json:"regex,computed"`
	Validation types.String `tfsdk:"validation" json:"validation,computed"`
}

type ZeroTrustDLPIntegrationEntriesConfidenceDataSourceModel struct {
...
type ZeroTrustDLPIntegrationEntriesVariantDataSourceModel struct {
