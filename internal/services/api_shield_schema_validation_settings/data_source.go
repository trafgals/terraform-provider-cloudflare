...
type APIShieldSchemaValidationSettingsDataSource struct {
...
func (d *APIShieldSchemaValidationSettingsDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
