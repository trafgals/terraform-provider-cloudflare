...
type LogpullRetentionDataSource struct {
...
func (d *LogpullRetentionDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
