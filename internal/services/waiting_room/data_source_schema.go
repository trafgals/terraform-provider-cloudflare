...
var _ datasource.DataSourceWithConfigValidators = (*WaitingRoomDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"additional_routes": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[WaitingRoomAdditionalRoutesDataSourceModel](ctx),
			...
			"cookie_attributes": schema.SingleNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectType[WaitingRoomCookieAttributesDataSourceModel](ctx),
				Attributes: map[string]schema.Attribute{
