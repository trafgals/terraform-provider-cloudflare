				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"additional_routes": schema.ListNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectListType[WaitingRoomsAdditionalRoutesDataSourceModel](ctx),
							NestedObject: schema.NestedAttributeObject{
								Attributes: map[string]schema.Attribute{
						...
						"cookie_attributes": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[WaitingRoomsCookieAttributesDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
...
func (d *WaitingRoomsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = ListDataSourceSchema(ctx)
}

func (d *WaitingRoomsDataSource) ConfigValidators(_ context.Context) []datasource.ConfigValidator {
