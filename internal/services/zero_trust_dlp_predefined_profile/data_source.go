...
type ZeroTrustDLPPredefinedProfileDataSource struct {
...
func (d *ZeroTrustDLPPredefinedProfileDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_zero_trust_dlp_predefined_profile"
}

func (d *ZeroTrustDLPPredefinedProfileDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ZeroTrustDLPPredefinedProfileDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ZeroTrustDLPPredefinedProfileDataSourceModel
