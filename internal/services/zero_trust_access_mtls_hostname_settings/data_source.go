...
type ZeroTrustAccessMTLSHostnameSettingsDataSource struct {
...
func (d *ZeroTrustAccessMTLSHostnameSettingsDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_zero_trust_access_mtls_hostname_settings"
}

func (d *ZeroTrustAccessMTLSHostnameSettingsDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ZeroTrustAccessMTLSHostnameSettingsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ZeroTrustAccessMTLSHostnameSettingsDataSourceModel
