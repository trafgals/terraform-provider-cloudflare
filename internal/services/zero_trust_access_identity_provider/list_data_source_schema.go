...
var _ datasource.DataSourceWithConfigValidators = (*ZeroTrustAccessIdentityProvidersDataSource)(nil)
	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"result": schema.ListNestedAttribute{
				...
				Computed:    true,
				CustomType:  customfield.NewNestedObjectListType[ZeroTrustAccessIdentityProvidersResultDataSourceModel](ctx),
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"config": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[ZeroTrustAccessIdentityProvidersConfigDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
								...
								"header_attributes": schema.ListNestedAttribute{
									...
									Computed:    true,
									CustomType:  customfield.NewNestedObjectListType[ZeroTrustAccessIdentityProvidersConfigHeaderAttributesDataSourceModel](ctx),
									NestedObject: schema.NestedAttributeObject{
										Attributes: map[string]schema.Attribute{
						...
						"scim_config": schema.SingleNestedAttribute{
							...
							Computed:    true,
							CustomType:  customfield.NewNestedObjectType[ZeroTrustAccessIdentityProvidersSCIMConfigDataSourceModel](ctx),
							Attributes: map[string]schema.Attribute{
...
func (d *ZeroTrustAccessIdentityProvidersDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
