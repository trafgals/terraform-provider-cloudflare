...
var _ datasource.DataSourceWithConfigure = (*WorkersKVNamespacesDataSource)(nil)
...
func (d *WorkersKVNamespacesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	env := WorkersKVNamespacesResultListDataSourceEnvelope{}
	...
	result, diags := customfield.NewObjectListFromAttributes[WorkersKVNamespacesResultDataSourceModel](ctx, acc)
	resp.Diagnostics.Append(diags...)
	data.Result = result
